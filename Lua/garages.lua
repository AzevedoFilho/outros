...
cfg.garage_types = {
  ...
  ["Exotic Cars"] = {
	...
	["FK8"] = {"Honda Civic",330000, "11 - (less numner better car"},
  ...
  ["Motorcycles"] = {
	...
	["f4rr"] = {"Agusta F4 RR",450000, ""},
    ["AKUMA"] = {"Akuma",37000, ""},
    ["bagger"] = {"Bagger",13000, ""},
    ["bati"] = {"XJ-6",55000, ""},
    ["bati2"] = {"Bati 801RR",40000, ""},
    ["bf400"] = {"BF400",33000, ""},
	["lectro"] = {"BMW R75 Bobber",38000, ""},
    ["carbonrs"] = {"Carbon RS",22000, ""},
    ["cliffhanger"] = {"Cliffhanger",23000, ""},
	["f131"] = {"Confederate F131 Hellcat",45000, ""},
    ["double"] = {"Double T",19000, ""},
    ["enduro"] = {"Enduro",15000, ""},
    ["faggio2"] = {"Faggio",5000, ""},
    ["gargoyle"] = {"Gargoyle",20000, ""},
    ["hakuchou"] = {"Hakuchou",50000, ""},
	["daemon"] = {"Harley Knucklehead",30000, ""},
    ["hexer"] = {"Hexer",17000, ""},
    ["innovation"] = {"Innovation",20000, ""},
    ["nemesis"] = {"Nemesis",28000, ""},
    ["pcj"] = {"PCJ-600",30000, ""},
    ["ruffian"] = {"Ruffian",21000, ""},
    ["sanchez"] = {"Sanchez",19000, ""},
    ["sovereign"] = {"Sovereign",10000, ""}, -- looking for replacement
    ["thrust"] = {"Thrust",12000, ""},
    ["vader"] = {"Vader",33800, ""},
	["150"] = {"CG 150", 25000, ""}, -- new adittion
    ["vindicator"] = {"Vindicator",26000,""}
  },
 ----------   
  ["House Garage"] = {
    ...
    ["feltzer2"] = {"Feltzer",130000, ""},
    ["furoregt"] = {"Furore GT",108000, ""},
	["gtr"] = {"GTR Nismo",190000, ""},
    ["jester"] = {"Jester",140000, ""},
    ["jester2"] = {"Jester (Racecar)",150000, ""},
    ["f620"] = {"Lexus RC350", 80000, ""},
    ["pigalle"] = {"Pigalle",90000, ""},
	["FK8"] = {"Honda Civic",180000, "6 - (less numner better car"},
    ["surano"] = {"Surano",95000, ""}
  },
...
cfg.garages = {
  ...
  {"High End",-297.96505737305,-990.47375488281,31.080614089966},

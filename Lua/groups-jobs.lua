...
cfg.groups = {
  ["superadmin"] = {
    _config = {onspawn = function(player) vRPclient.notify(player,{"Você esta como superadmin."}) end},
    "player.group.add",
    "player.group.remove",
    "player.givemoney",
    "player.giveitem"
  ...
  ["Fisher"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é um pescador."}) end
	},
  ...
  ["Cargo Pilot"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é um Piloto de Carga. Salário: $4000."}) end
	},
	"mission.pilot.cargo",
	"pilot.vehicle",
	"pilot.paycheck"
  ...
  ["Airline Pilot"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é Piloto, Salário : $4000."}) end
	},
    "airlines.service",
	"air.vehicle",
	"air.paycheck"
  ...
  ["Medical Transport"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é entregador de ERVA."}) end
	},
  ...
  ["Weapons Smuggler"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é um traficante de armas."}) end
	},
  ...
  ["Chefe da Samu"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é chefe geral da Samu, salário : $12000."}) end
	},
    "emergency.revive",
	"police.pc",
	--"police.wanted",
  ...
  ["Agente de Procura e Resgate"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é agente de Procura e Resgate, salário : $4500."}) end
	},
    "emergency.revive",
	"police.pc",
	--"police.wanted",
  ...
  ["Tenente de Emergência"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é tenente de emergência, salário de : $8000."}) end
	},
    "emergency.revive",
	"police.pc",
	--"police.wanted",
  ...
  ["Paramédico(SAMU)"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é paramédico da Samu, salário de : $6000."}) end
	},
    "emergency.revive",
	"police.pc",
	--"police.wanted",
  ...
  ["Mechanic"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é mecânico, salary : $2000."}) end
	},
    "vehicle.repair",
    "vehicle.replace",
    "repair.service",
  ...
  ["Forger"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você agora é vigarista, vá pegar alguns cartões com os hackers."}) end
	},
    "fraud.credit_cards",
	"forger.mission"
  },
...
--},
  ["Unemployed"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are Desempregado, vá procurar um emprego rapá!."}) end
	},
	"citizen.paycheck"
  },
  ["Delivery"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é entregador, Salário : $2000."}) end
	},
  ...
  ["Trash Collector"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é gari, Salário : $2000."}) end
	},
  ...
  ["Lawyer"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é Advogado, Salário : $2500."}) end
	},
	"Lawyer.vehicle",
	"Lawyer.whitelisted",
	"Lawyer.cloakroom",
  ...
  ["Drug Dealer"] = {
    _config = { gtype = "job",
	    onspawn = function(player) vRPclient.notify(player,{"Você é Traficante de Drogas."}) end
	  },
  ...
  ["Hacker"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é Hacker."}) end
	},
  ...
  ["Bankdriver"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é transportador de valores. Salário: $2700."}) end
	},
  ...
  ["Judge"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Você é Juiz. Salário : $5000"}) end
	},
	"judge.paycheck",
	"Judge.whitelisted"
  },
  ...
  ["Recruta da Polícia"] = {
   ...
   -- "-police.store_weapons",
    "-police.seizable",	-- negative permission, police can't seize itself, even if another group add the permission
	"Cadet.vehicle", -- police.vehicle or Cadet.vehicle
	"police.loadshop",
	"cop.whitelisted",
	"Cadet.paycheck",
	"police.menu_interaction",
  ...
  ["Xerife"] = {
   ...
   -- "-police.store_weapons",
	...
	"police.mission"
 	...
 	--Comentando, antigo Soldado da Polícia.
  ["Polícia Federal"] = {
    _config = { gtype = "job",
	  onjoin = function(player) vRPclient.setCop(player,{true}) end,
      onspawn = function(player) vRPclient.setCop(player,{true}) end,
  ...
  --Capitão da Polícia (falta roupa).
      ["Capitão da Polícia"] = {
    _config = { gtype = "job",
	  onjoin = function(player) vRPclient.setCop(player,{true}) end,
      onspawn = function(player) vRPclient.setCop(player,{true}) end,
  ...
  -- Podemos mudar a roupa do policial.
    ["Tenente da Polícia"] = {
    _config = { gtype = "job",
	  onjoin = function(player) vRPclient.setCop(player,{true}) end,
      onspawn = function(player) vRPclient.setCop(player,{true}) end,
